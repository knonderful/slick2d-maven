...
public abstract class ControlPanel extends DefaultPanel implements InputPanelListener {
  ...
  /**
   * @see
   * org.newdawn.slick.tools.peditor.InputPanelListener#minMaxUpdated(org.newdawn.slick.tools.peditor.MinMaxPanel)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.tools.peditor.InputPanelListener#valueUpdated(org.newdawn.slick.tools.peditor.ValuePanel)
   */
