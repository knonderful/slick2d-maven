...
public class WhiskasPanel extends ControlPanel {
   ...
   * @param colorPanel The panel controlling the colours that needs to be
   * controlled based on the enablement here
   * @param emissionControls The panel controlling the emissions that needs to
   * be controlled based on the enablement here
   */
  ...
  /**
   * @see
   * org.newdawn.slick.tools.peditor.ControlPanel#linkEmitterToFields(org.newdawn.slick.particles.ConfigurableEmitter)
   */
