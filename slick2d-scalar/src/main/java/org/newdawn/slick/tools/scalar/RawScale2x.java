...
public class RawScale2x {
  ...
  /**
   * Check if two pixels are different. Place holder for maybe some clever code
   * about tolerance checking
   *
  ...
  /**
   * Get the scale image data. Note this is the method that does the work so it
