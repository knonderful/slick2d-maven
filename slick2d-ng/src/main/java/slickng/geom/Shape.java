...
public abstract class Shape implements Serializable {
   ...
   * @return True if the other shape supplied is entirely contained within this
   * one.
   */
   ...
   * @return The index of the point or -1 if the point is not part of this shape
   * path
   */
