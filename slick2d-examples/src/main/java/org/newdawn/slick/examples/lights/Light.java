...
/**
 * A single light in the example. It's capable of determining how much effect it
 * will have in any given point on the tile map. Note that all coordinates are
 * given in tile coordinates rather than pixel coordinates.
 *
 * @author kevin
 */
class Light {
  ...
  private float ypos;
  /**
   * The strength of the light, this specifies in tiles how far the light will
   * shine
   */
   ...
   * @param str The strength of the light, this specifies in tiles how far the
   * light will shine
   ...
   *
   * @return The effect on a given location of the light in terms of colour
   * components (all the same if we don't support coloured lights)
   */
