...
public class TTFSubSetFile extends TTFFile {
   ...
   * indexToLocaFormat to long and set checkSumAdjustment to 0, store offset to
   * checkSumAdjustment in checkSumAdjustmentOffset
   *
   ...
   * The glyphs Map contains an Integer key and Integer value that maps the
   * original metric (key) to the subset metric (value)
   *
   ...
   * @param glyphs Map of glyphs (glyphs has old index as (Integer) key and new
  ...
  /**
   *
   * Appends a ULONG to the output array, at the given position without changing
   * currentPos
   *
   * @param pos The position to write to
   * @param s The value to write
