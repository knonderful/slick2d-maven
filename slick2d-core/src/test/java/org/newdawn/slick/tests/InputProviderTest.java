...
public class InputProviderTest extends BasicGame implements InputProviderListener {
  ...
  /**
   * @see
   * org.newdawn.slick.command.InputProviderListener#controlPressed(org.newdawn.slick.command.Command)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.command.InputProviderListener#controlReleased(org.newdawn.slick.command.Command)
   */
