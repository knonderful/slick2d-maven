...
public interface MouseListener extends ControlledInputReciever {
  ...
  /**
   * Notification that a mouse button was clicked. Due to double click handling
   * the single click may be delayed slightly. For absolute notification of
   * single clicks use mousePressed().
   *
