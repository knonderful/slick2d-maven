...
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#initDisplay(int,
   * int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBegin(int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glColor4f(float,
   * float, float, float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexCoord2f(float,
   * float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex2f(float,
   * float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex3f(float,
   * float, float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBindTexture(int,
   * int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBlendFunc(int,
   * int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glCallList(int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glClear(int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glClipPlane(int,
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glColorMask(boolean,
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glDisable(int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glEnable(int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glLineWidth(float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glPointSize(float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glPopMatrix()
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glPushMatrix()
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glRotatef(float,
   * float, float, float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScalef(float,
   * float, float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScissor(int,
   * int, int, int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexEnvi(int,
   * int, int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTranslatef(float,
   * float, float)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glNewList(int,
   * int)
   */
  ...
  /**
   * @see
   * org.newdawn.slick.opengl.renderer.SGL#glLoadMatrix(java.nio.FloatBuffer)
   */
