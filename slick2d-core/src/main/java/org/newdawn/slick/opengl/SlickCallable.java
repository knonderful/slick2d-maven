...
public abstract class SlickCallable {
   ...
   * performGLOperations()). This method will block until the GL operations have
   * been performed.
   *
   * @throws SlickException Indicates a failure while performing the GL
   * operations or maintaing SlickState
   */
   ...
   *
   * @throws SlickException Indicates a failure of some sort. This is user
   * exception
   */
