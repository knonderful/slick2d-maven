...
public class GlyphPage {
   ...
   *
   * If this page already has glyphs and maxGlyphsToLoad is -1, then this method
   * will return 0 if all the new glyphs don't fit. This reduces texture binds
   * when drawing since glyphs loaded at once are typically displayed together.
   *
   * @param glyphs The glyphs to load.
   * @param maxGlyphsToLoad This is the maximum number of glyphs to load from
   * the list. Set to -1 to attempt to load all the glyphs.
