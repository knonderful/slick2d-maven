...
public class ShadowEffect implements ConfigurableEffect {
   ...
   * @param xDistance The distance from the text on the x axis the shadow should
   * be rendered
   * @param yDistance The distance from the text on the y axis the shadow should
   * be rendered
  ...
  /**
   * @see
   * org.newdawn.slick.font.effects.Effect#draw(java.awt.image.BufferedImage,
  ...
  /**
   * Get the distance on the X axis from the text the shadow should be generated
   * at
   *
  ...
  /**
   * Get the distance on the Y axis from the text the shadow should be generated
   * at
   *
  ...
  /**
   * Sets how many neighboring pixels are used to blur the shadow. Set to 0 for
   * no blur.
   *
  ...
  /**
   * @see
   * org.newdawn.slick.font.effects.ConfigurableEffect#setValues(java.util.List)
   */
