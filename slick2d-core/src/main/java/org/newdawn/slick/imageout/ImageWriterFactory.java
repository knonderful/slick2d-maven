...
public class ImageWriterFactory {
  ...
  /**
   * Register an image writer with the factory. This will allow users to use it
   * to write out the explicit format
   *
   * @param format The format (usually extension) of the files that will be
   * written out
