...
public class ImageOut {
   ...
   * @throws SlickException Indicates a failure to write the image in the
   * specified format
   */
   ...
   * @param format The format to write the image out in
   * @param out The output stream to which the image should be written
   * @param writeAlpha True if we should write the alpha channel out (some
   * formats don't support this, like JPG)
   * @throws SlickException Indicates a failure to write the image in the
   * specified format
   */
