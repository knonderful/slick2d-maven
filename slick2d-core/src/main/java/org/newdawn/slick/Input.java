...
public class Input {
  ...
  /**
   * Set the double click interval, the time between the first and second clicks
   * that should be interpreted as a double click.
   *
  ...
  /**
   * Set the pixel distance the mouse can move to accept a mouse click. Default
   * is 5.
   *
   ...
   *
   * @param button The button to check for (note that this includes directional
   * controls first)
  ...
  /**
   * Clear the state for the <code>isKeyPressed</code> method. This will resort
   * in all keys returning that they haven't been pressed, until they are
   * pressed again
   */
  ...
  /**
   * Hook to allow us to translate any key character into special key codes for
   * easier use.
   *
  ...
  /**
   * Enable key repeat for this input context. This will cause keyPressed to get
   * called repeatedly at a set interval while the key is pressed
   *
   ...
   * @param controllerIndex The index of the controller on which the control was
   * pressed
   */
   ...
   * @param controllerIndex The index of the control to which the control
   * belongs
   ...
   * @param clickCount The number of times the button was clicked (single or
   * double click)
   */
