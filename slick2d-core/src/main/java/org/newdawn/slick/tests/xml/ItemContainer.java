...
public class ItemContainer extends Item {
   ...
   * used as well as direct field injection. In this case the setter *has* to be
   * used to access the protected field from the super class
   *
   ...
   * be used as well as direct field injection. In this case the setter *has* to
