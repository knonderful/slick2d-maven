...
public class TrueTypeFont implements org.newdawn.slick.Font {
  ...
  /**
   * Constructor for the TrueTypeFont class Pass in the preloaded standard Java
   * TrueType font, and whether you want it to be cached with AntiAliasing
   * applied.
   *
   * @param font Standard Java AWT font
   * @param antiAlias Whether or not to apply AntiAliasing to the cached font
   * @param additionalChars Characters of font that will be used in addition of
   * first 256 (by unicode).
   */
