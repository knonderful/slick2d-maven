...
public class AudioLoader {
   ...
   * memory.
   *
   * @param format The format of the audio to be loaded (something like "XM" or
   * "OGG")
  ...
  /**
   * Get audio data in a playable state by setting up a stream that can be piped
   * into OpenAL - i.e. streaming audio
   *
   * @param format The format of the audio to be loaded (something like "XM" or
   * "OGG")
