 ...
 * @author Mark Bernard
 *
 * Use this class to render shpaes directly to OpenGL. Allows you to bypass the
 * Graphics class.
 */
public final class ShapeRenderer {
  ...
  /**
   * Draw the outline of the given shape. Only the vertices are set. The colour
  ...
  /**
   * Draw the the given shape filled in with a texture. Only the vertices are
   * set. The colour has to be set independently of this method. This method is
   * required to fit the texture once across the shape.
   *
   * @param shape The shape to texture.
   * @param image The image to tile across the shape
   */
   ...
   * Draw the the given shape filled in with a texture. Only the vertices are
   * set. The colour has to be set independently of this method. This method is
   * required to fit the texture scaleX times across the shape and scaleY times
   * down the shape.
   *
   * @param shape The shape to texture.
   * @param image The image to tile across the shape
   ...
   * @param shape The shape to texture.
   * @param image The image to tile across the shape
   * @param gen The texture coordinate generator to create coordiantes for the
   * shape
   */
