...
public class InputProvider {
   ...
   * the commands that can be issued to the listeners
   *
  ...
  /**
   * Add a listener to the provider. This listener will be notified of commands
   ...
   * @param control The control that is pressed/released to represent the
   * command
   */
  ...
  /**
   * A token representing the state of all the controls causing an command to be
   * invoked
   *
   * @author kevin
   */
