...
/**
 * A control relating to a command indicate that it should be fired when a
 * specific key is pressed or released.
 *
 * @author joverton
 */
public class KeyControl implements Control {
  ...
  /**
   * Create a new control that caused an command to be fired on a key
   * pressed/released
   *
