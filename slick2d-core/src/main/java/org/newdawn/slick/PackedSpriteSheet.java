...
public class PackedSpriteSheet {
  ...
  private Image image;
  /**
   * The base path where the image is expected to be found based on the original
   * definition file
   */
   ...
   * @param trans The color to be treated as transparent
   * @throws SlickException Indicates a failure to read or parse the definitions
   * file or referenced image.
   */
