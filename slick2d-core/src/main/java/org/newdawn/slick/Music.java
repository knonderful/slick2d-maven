...
public class Music {
  ...
  /**
   * Poll the state of the current music. This causes streaming music to stream
   * and checks listeners. Note that if you're using a game container this will
   * be auto-magically called for you.
   *
   ...
   * @throws SlickException Indicates a failure to read the music from the
   * stream
   */
   ...
   * @param streamingHint A hint to indicate whether streaming should be used if
   * possible
   * @throws SlickException
   */
   ...
   * @param pitch The pitch to play the music at (1.0 = default)
   * @param volume The volume to play the music at (1.0 = default)
   * @param loop if false the music is played once, the music is looped
   * otherwise
   */
   ...
   * tick.
   *
   * @param delta The amount of time in milliseconds thats passed since last
   * update
   */
