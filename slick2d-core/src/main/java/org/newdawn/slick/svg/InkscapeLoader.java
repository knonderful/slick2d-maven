...
public class InkscapeLoader implements Loader {
  ...
  /**
   * The number of times to over trigulate to get enough tesselation for smooth
   * shading
   */
  ...
  /**
   * Add an <code>ElementProcessor</code> which will be passed each element read
   * as the Inkscape SVG document is processed.
   *
