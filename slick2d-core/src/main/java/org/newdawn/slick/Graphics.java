...
public class Graphics {
  ...
  /**
   * Set the drawing mode to use. This mode defines how pixels are drawn to the
   * graphics context. It can be used to draw into the alpha map.
   *
  ...
  /**
   * Clear the state of the alpha map across the entire screen. This sets alpha
   * to 0 everywhere, meaning in {@link Graphics#MODE_ALPHA_BLEND} nothing will
   * be drawn.
   */
  ...
  /**
   * Must be called before all OpenGL operations to maintain context for dynamic
   * images
   */
  ...
  /**
   * Must be called after all OpenGL operations to maintain context for dynamic
   * images
   */
  ...
  /**
   * Set the background colour of the graphics context. This colour is used when
   * clearing the context. Note that calling this method alone does not cause
  ...
  /**
   * Set clipping that controls which areas of the world will be drawn to. Note
   * that world clip is different from standard screen clip in that it's defined
   * in the space of the current world coordinate - i.e. it's affected by
   ...
   *
   * @param x1 The x coordinate of the top left corner of a box containing the
   * oval
   * @param y1 The y coordinate of the top left corner of a box containing the
   * oval
  ...
  /**
   * Copy an area of the rendered screen into an image. The width and height of
   * the area are assumed to match that of the image
   *
   ...
   * popTransform() must be performed to restore the state before the end of the
   * rendering loop.
   */
   ...
   * However this will also invalidate it's use
   */
  public void destroy() {
