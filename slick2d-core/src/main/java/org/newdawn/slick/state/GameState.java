...
public interface GameState extends InputListener {
   ...
   * @param container The container holding the game
   * @param game The game holding this state
   * @param delta The amount of time thats passed in millisecond since last
   * update
   * @throws SlickException Indicates an internal error that will be reported
   * through the standard framework mechanism
   */
