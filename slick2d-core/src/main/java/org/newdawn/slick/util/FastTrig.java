...
public class FastTrig {
  ...
  /**
   * Fast Trig functions for x86. This forces the trig functiosn to stay within
   * the safe area on the x86 processor (-45 degrees to +45 degrees) The results
   * may be very slightly off from what the Math and StrictMath trig functions
   * give due to rounding in the angle reduction but it will be very very close.
   *
