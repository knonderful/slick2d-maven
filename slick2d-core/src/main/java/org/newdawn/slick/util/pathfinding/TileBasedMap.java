...
public interface TileBasedMap {
  ...
  /**
   * Get the width of the tile map. The slightly odd name is used to distiguish
   * this method from commonly used names in game maps.
   *
  ...
  /**
   * Get the height of the tile map. The slightly odd name is used to distiguish
   * this method from commonly used names in game maps.
   *
   ...
   * supplied mover.
   *
   * @param context The context describing the pathfinding at the time of this
   * request
