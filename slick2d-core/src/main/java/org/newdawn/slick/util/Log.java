...
public final class Log {
   ...
   * logging mode to verbose for games that were released without verbose
   * logging value must be "true"
   */
   ...
   * Only be called when system property "org.newdawn.slick.forceVerboseLog" is
   * set to true. You must not call this method directly.
   */
