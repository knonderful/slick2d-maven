...
public class FontUtils {
  ...
  /**
   * Calculates and returns the width of a single justified space for the given
   * {@link String}, in pixels.
   *
   * @param font The font to draw with
   * @param s The given non-null {@link String} to use to calculate the width of
   * a space for.
   ...
   * @return The width of a single justified space for the given {@link String},
   * in pixels.
   */
   ...
   * {@link String}.
   * @param justifiedSpaceWidth The integer specifying the width of a justified
   * space {@link String}, in pixels.
   * @return The resulting x-coordinate of the current cursor after the drawing
   * operation completes.
