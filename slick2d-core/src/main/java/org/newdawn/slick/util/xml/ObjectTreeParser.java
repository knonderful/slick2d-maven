...
public class ObjectTreeParser {
   ...
   * This is sometimes useful to not clash with the existing data model methods.
   *
   ...
   * @throws SlickXMLException Indicates a failure to parse the XML, most likely
   * the XML is malformed in some way.
   */
  ...
  /**
   * Deterine the name of the class that should be used for a given XML element
   * name.
   *
   ...
   * @throws SlickXMLException Indicates there is no automatic way of converting
  ...
  /**
   * Find a field in a class by it's name. Note that this method is only needed
   * because the general reflection method is case sensitive
   *
  ...
  /**
   * Find a method in a class by it's name. Note that this method is only needed
   * because the general reflection method is case sensitive
   *
   * @param clazz The clazz to search
