...
public class AppletGameContainer extends Applet {
  ...
  public class Container extends GameContainer {
     ...
     *
     * @throws SlickException Indicates a failure to inialise the basic
     * framework
     */
     ...
     *
     * @throws Exception Indicates a failure within the game's loop rather than
     * the framework
     */
   ...
   * will prevent the applet from just freezing in the browser and give the end
   * user an a nice gui where the error message can easily be viewed and copied.
   */
