...
public class ParticleSystem {
   ...
   * set for each emitter. actually this is used to allow setting an individual
  ...
  /**
   * Indicate whether the particle system should be visible, i.e. whether it'll
   * actually render
   *
   ...
   * Render the particles in the system
   *
   * @param x The x coordinate to render the particle system at (in the current
   * coordinate space)
   * @param y The y coordinate to render the particle system at (in the current
   * coordiante space)
   */
   ...
   * @throws SlickException Indicates a failure during copy or a invalid
   * particle system to be duplicated
   */
